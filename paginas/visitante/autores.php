...
<body style="background: url(../../assets/img/fondo3.jpg); background-size: cover">
    <nav class="navbar navbar-expand-lg navbar-dark" style="background: rgba(0, 0, 0, .7)">
        <span class="navbar-brand mb-0 h1">Autores</span>
    ...
    <div class="container shadow p-3 mb-5 bg-white rounded" style="margin-top: 30px">
        <h3>Biblioteca</h3>
        <hr>
        <h5>Listado general de autores</h5>
        ...
        <table class="table table-bordered table-hover text-center">
            ...
            <tbody id="tbl_autores">

            </tbody>
        </table>
        <nav aria-label="Page navigation">
            <ul class="pagination justify-content-center" id="div_botones_autores">
    ...
    <script type="text/javascript" src="../javascript/autores.js"></script>
</body>
</html>