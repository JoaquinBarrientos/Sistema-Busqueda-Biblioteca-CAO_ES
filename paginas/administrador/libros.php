...
<body style="background: url(../../assets/img/fondo.jpg)">
    ...
    <div class="container shadow p-3 mb-5 bg-white rounded" style="margin-top: 30px">
        <h3>Biblioteca</h3>
        <label class="panel-body">Listado general de libros</label>
        <a href="nuevo_libro.php"><button class="btn btn-sm btn-primary ">Agregar nuevo libro</button></a>
        <hr>
        <table id="tbl_libros" class="table table-bordered table-hover text-center">
